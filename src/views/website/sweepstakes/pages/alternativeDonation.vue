  ...
  <div>
    ...
    <section>
      <div class="container">
        ...
        <div class="section_body" id="freeDonation">
          <div class="body_top">
            <h3>Why not give back?</h3>
            <p>
              The prizes we offer raise money to support incredible causes.When
              you donate for your chance to win, you truly make a difference.
              It's a win-win.
            </p>
            <LoaderButton
              class="btn-yellow"
              ...
              @emitClick="
                $router.push(
                  `/sweepstakes/${slug}/sweepstake-payment?entries=20&price=2`
                )
              "
            />
          </div>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations("publicweb/sweepstake", ["setPageFreeDonation"]),
    async sendData() {
      const data = {
